<template>
  <div class="Account container">
    ...
    <!-- 帳號修改modal -->
    <b-modal centered v-model="modAccountModalShow" size="xl" no-close-on-backdrop no-close-on-esc>
    ...
    commonQueryResponse: {
      handler() {
        ...
        for (var i = 0; i < vm.commonQueryResponse.length; i++) {
          ...
          itemsobj["noumenonID"] = vm.commonQueryResponse[i]["noumenonID"];
  ...
  methods: {
    ...
    setSystemFormData(moditemobj) {
      ...
      if (this.tabIndex == 0) {
        ...
        vforData["noumenonID"] = ["depselect", "部門", moditemobj.noumenonID];
        vforData["accessList"] = [
          "accesscheckbox",
          "使用者權限",
    ...
    setSystemFormSelectOptionsFunc() {
      ...
      var params = {};
      params["methods"] = "GET";
      params["whichFunction"] = "CommonQuery";
    ...
    AccountMod() {
      ...
      if (
        Object.values(vm.systemFormCompletedData.accessList).indexOf(false) !=
        -1
      ) {
