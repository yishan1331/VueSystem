    ...
    <div class="SOP container">
        ...
        >
            ...
            <template v-slot:default>
                <b-row class="my-4">
                    <b-col sm="2">
                        <label for="input-default">大綱</label>
                    </b-col>
                    <b-col sm="10">
                        <b-form-input
                ...
                <b-row class="my-4">
                    <b-col sm="2">
                        <label for="input-default">用途</label>
                    </b-col>
                    <b-col sm="10">
                        <b-form-input
                            v-model.trim="form.application"
                            type="text"
                        ></b-form-input>
                    </b-col>
                </b-row>
...
export default {
    ...
    methods: {
        ...
        SetCommonQueryData() {
            var vm = this;
            var sopqueryoptions = [];
            var sopqueryselected =
                vm.pageAccess.report.children.sop.remark.commonQueryCondition
                    .main;
            if (
                vm.pageAccess.report.children.sop.remark.commonQueryCondition
                    .main == "ALL"
                ...
                sopqueryoptions =
                    vm.pageAccessConfig.report.children.sop.remark
                        .commonQueryCondition.main.options;
            } else {
                sopqueryoptions = [
                    {
                        text:
                            vm.depDetail.config[
                                vm.pageAccess.report.children.sop.remark
            ...
            obj.options = sopqueryoptions;
            obj.selected = sopqueryselected;
            console.log(obj);
            vm.setinputData(obj);
            ...
            commonApiParams.normal.table = "SOP";
        ...
        addAction() {
            ...
            formData.append("application", vm.form.application);
            formData.append("filename", vm.form.filename);
            formData.append("depID", vm.depStaffRelation);
            ...
            instance
                .post("/php/views/sop/SOPAdd.php", formData, config)
                .then(
                    function (response) {
        ...
        onDownload(params) {
            ...
            let anyerror = false;
            axios({
                url: "/php/views/sop/SOPSMBAction.php",
                method: "POST",
                data: {
        ...
        modAction() {
            ...
            formData.append("application", vm.modfrom.application);
            let thislevel = 0;
            ...
            instance
                .post("/php/views/sop/SOPMod.php", formData, config)
                .then(
                    function (response) {
                        console.log(response);
                        const result = response.data;
        ...
        delAction(params) {
            ...
            axios
                .post("/php/views/sop/SOPDel.php", apiparams)
                .then(
                    function (response) {
                        console.log(response);
                        const result = response.data;
        ...
        toggleAddModal() {
            ...
            console.log(vm.depDetail.config);
            if (
                vm.pageAccess.report.children.sop.remark.commonQueryCondition
                    .main === "ALL"
            ) {
                Object.values(vm.depDetail.config).map((item) => {
                ...
                vm.form.root =
                    vm.depDetail.config[
                        vm.pageAccess.report.children.sop.remark.commonQueryCondition.main
                    ];
                vm.rootChange(
                    vm.depDetail.config[
                        vm.pageAccess.report.children.sop.remark
        ...
        toggleModModal(params) {
            ...
            vm.modfrom.application = thisitem.application;
